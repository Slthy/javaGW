...
public class Homework3 {
	 ...
	 * 
	 * Please turn on all the test case flags before submission to BB, and make sure
	 * your
	 ...
	 * number entered by the user (i.e. if the users enter 1, sum the numbers 1
	 * through 9 inclusive).
	 */
	 ...
	 * a seed number entered by the user (i.e. if the users enter 1, sum the numbers
	 ...
	 ****************************************************************************/
	/*
	 * Write a loop that sums up all the factors of a natural number entered by the
	 * user.
	 */
	...
	public static int main7(int width, int height, int column) {

		int sum = 0;
		for (int h = 0; h < height; h++)
			sum += width * h + column + 1; // tiles' numbers start from 1.
		return sum;
	}
	 ...
	 ****************************************************************************/
	/*
	 * Write code to find the minimum value of a list of integers entered by the
	 * user.
	 */
	 ...
	 ****************************************************************************/
	/*
	 * Write code to find the average (mean) value of a list of integers entered by
	 * the user.
	 */
	...
	public static void main(String[] args) {
		...
		if (test1 == true) {
			completed = true;
			try {
				completed = testChecker("main1", "test1", main1(1), new ArrayList<Integer>(Arrays.asList(1)), 45)
						&& completed;
		...
		if (test2 == true) {
			completed = true;
			try {
				completed = testChecker("main2", "test1", main2(1), new ArrayList<Integer>(Arrays.asList(1)), 25)
						&& completed;
			} catch (Exception exception) {
				completed = false;
		...
		if (test3 == true) {
			completed = true;
			try {
				completed = testChecker("main3", "test1", main3(0), new ArrayList<Integer>(Arrays.asList(0)), 1)
						&& completed;
			} catch (Exception exception) {
				completed = false;
			...
			try {
				completed = testChecker("main3", "test2", main3(2), new ArrayList<Integer>(Arrays.asList(2)), 2)
						&& completed;
			} catch (Exception exception) {
				completed = false;
			...
			try {
				completed = testChecker("main3", "test3", main3(3), new ArrayList<Integer>(Arrays.asList(3)), 6)
						&& completed;
			} catch (Exception exception) {
				completed = false;
			...
			try {
				completed = testChecker("main3", "test4", main3(1), new ArrayList<Integer>(Arrays.asList(1)), 1)
						&& completed;
			} catch (Exception exception) {
				completed = false;
		...
		if (test4 == true) {
			completed = true;
			try {
				completed = testChecker("main4", "test1", main4(0), new ArrayList<Integer>(Arrays.asList(0)), 0)
						&& completed;
			} catch (Exception exception) {
				completed = false;
			...
			try {
				completed = testChecker("main4", "test2", main4(1), new ArrayList<Integer>(Arrays.asList(1)), 1)
						&& completed;
			} catch (Exception exception) {
				completed = false;
			...
			try {
				completed = testChecker("main4", "test3", main4(2), new ArrayList<Integer>(Arrays.asList(2)), 1)
						&& completed;
			} catch (Exception exception) {
				completed = false;
			...
			try {
				completed = testChecker("main4", "test4", main4(4), new ArrayList<Integer>(Arrays.asList(4)), 3)
						&& completed;
			} catch (Exception exception) {
				completed = false;
			...
			try {
				completed = testChecker("main4", "test4", main4(23), new ArrayList<Integer>(Arrays.asList(23)), 28657)
						&& completed;
			} catch (Exception exception) {
				completed = false;
		...
		if (test5 == true) {
			completed = true;
			try {
				completed = testChecker("main5", "test1", main5(), new ArrayList<Integer>(Arrays.asList()), 70)
						&& completed;
			} catch (Exception exception) {
				completed = false;
		...
		if (test6 == true) {
			completed = true;
			try {
				completed = testChecker("main6", "test1", main6(1), new ArrayList<Integer>(Arrays.asList(1)), 1)
						&& completed;
			} catch (Exception exception) {
				completed = false;
			...
			try {
				completed = testChecker("main6", "test2", main6(3), new ArrayList<Integer>(Arrays.asList(3)), 4)
						&& completed;
			} catch (Exception exception) {
				completed = false;
			...
			try {
				completed = testChecker("main6", "test3", main6(4), new ArrayList<Integer>(Arrays.asList(4)), 7)
						&& completed;
			} catch (Exception exception) {
				completed = false;
			...
			try {
				completed = testChecker("main6", "test4", main6(2), new ArrayList<Integer>(Arrays.asList(2)), 3)
						&& completed;
			} catch (Exception exception) {
				completed = false;
		...
		if (test7 == true) {
			completed = true;
			try {
				completed = testChecker("main7", "test1", main7(4, 3, 0),
						new ArrayList<Integer>(Arrays.asList(4, 3, 0)), 15) && completed;
			} catch (Exception exception) {
				completed = false;
				System.out.println("Oops! Check your main7, test1, on inputs 4,3,0 -- it raised an exception.");
			}
			try {
				completed = testChecker("main7", "test2", main7(4, 3, 3),
						new ArrayList<Integer>(Arrays.asList(4, 3, 3)), 24) && completed;
			} catch (Exception exception) {
				completed = false;
				System.out.println("Oops! Check your main7, test2, on inputs 4,3,3 -- it raised an exception.");
			}
			try {
				completed = testChecker("main7", "test3", main7(4, 3, 1),
						new ArrayList<Integer>(Arrays.asList(4, 3, 1)), 18) && completed;
			} catch (Exception exception) {
				completed = false;
		...
		if (test9 == true) {
			...
			System.out.println("skipping test9");

		if (!(test1 == true && test2 == true && test3 == true && test4 == true && test5 == true
				&& test6 == true && test7 == true && test8 == true && test9 == true))
			System.out.println(
					"Please set all test cases to true before submitting your file called Homework1.java to Blackboard.");
		...
		System.out.println("\n***YOUR SCORE ON THIS ASSIGNMENT: ( " + score
				+ " + [up to 4 points for style] ) out of 13 total***\n");
